...
<head>
  ...
  <title>Sistem Pakar Diagnosis Gangguan Kecemasan - Basis Pengetahuan Gangguan Kecemasan</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Basis Pengetahuan Gangguan Kecemasan</h1>
    </div><!-- End Page Title -->
    <br>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                include "../koneksi.php";
                $sql = "SELECT * FROM rule INNER JOIN gejala ON rule.kode_gejala=gejala.kode_gejala 
                JOIN gangguan ON rule.kode_gangguan=gangguan.kode_gangguan ORDER BY id_rule";
                $qry = mysqli_query($koneksi, $sql) or die("SQL Error" . mysqli_error($koneksi));
                $no = 0;
                while ($data = mysqli_fetch_array($qry)) {
                  $no++;
