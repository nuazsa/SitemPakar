...
if ($id_ubah != "") {
  ...
  $id = $data['id_rule'];
  $edit_pernyataan = $data['kode_pernyataan'];
  $edit_model = $data['kode_model'];
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Basis Pengetahuan Pemodelan Data</h1>
    </div><!-- End Page Title -->
    ...
    <section>
                      ...
                      <div class="col-sm-4">
                        <select name="daftarpernyataan" id="daftarpernyataan" style="width: 630px;" required>
                          ...
                          while ($datap = mysqli_fetch_array($qryp)) {
                            if ($datap['kode_pernyataan'] == $edit_pernyataan) {
                              $cek = "selected";
                            } else {
                              $cek = "";
                            }
                      ...
                      <label for="" class="col-md-4 offset-md-0">Jenis Model Data</label>
                        ...
                        <select name="daftarpenyakit" id="daftarpenyakit" style="width: 630px;" required>
                          <?php
                            ...
                            while ($datap = mysqli_fetch_array($qryp)) {
                              if ($datap['kode_model'] == $edit_model) {
                                $cek = "selected";
                              } else {
                                $cek = "";
                              }
                              $arrPenyakit["$datap[kode_model]"] = $datap['nama_model'];
      ...
      if (isset($_POST['simpan'])) {
        ...
        $sql = "UPDATE rule SET kode_pernyataan='$kd_pernyataan', kode_model='$kd_penyakit', nilai_densitas='$belief' WHERE id_rule='$id'";
