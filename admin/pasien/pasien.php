...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Basis Kasus Gangguan Kecemasan</h1>
    </div><!-- End Page Title -->
    <br>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $no; ?></td>
                    <td align=justify><?php echo $data['nama_pasien']; ?></td>
                    <td align=center><?php echo $data['umur']; ?> Tahun</td>
                    <td><a href="./detail.php?detail=<?php echo $data['id_pasien']; ?>" class="btn  bg-info btn-sm"  style="color: white;"><i class="bi bi-info-square"></i> Detail</a></td>
                    </td>
                  </tr><?php } ?>
              </tbody>
            </table>
