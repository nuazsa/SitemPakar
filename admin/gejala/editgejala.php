...
<meta charset="utf-8">
  ...
  <title>Sistem Pakar Diagnosis Gangguan Kecemasan - Gejala Gangguan Kecemasan</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../gejala/gejala.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Gejala Gangguan Kecemasan</h1>
    </div><!-- End Page Title -->
    ...
    <div class="col-md-12">
      ...
      <form method="post" action="">
        <div class="form-group row mb-3">
          <label for="edit_gejala" class="col-md-2 offset-md-0">Nama Gejala</label>
          <div class="col-sm-10">
          <textarea type="text" rows="5" class="form-control" id="edit_gejala" name="edit_gejala" value=""> <?php echo $edit_gejala; ?></textarea>
          </div>
        </div>
        <div class="form-group row mb-3 offset-md-2">
          <div>
            <button class="btn btn-primary mt-4 btn-md" name="simpan" type="submit" style="background-color: #9370db; padding: 6px 150px;"><i class="bi bi-check-lg"></i> Update</button>
            <a href="./gejala.php" class="btn btn-danger mt-4 btn-md"  style="float: right; padding: 6px 150px;"> <i class="bi bi-x"></i> Batal</a>
          </div>
        </div>
      </form>
    </div>
  ...
  $sql = "UPDATE gejala SET nama_gejala='$gejala' WHERE kode_gejala='$id'";
  $result = mysqli_query($koneksi, $sql) or die("SQL Error" . mysqli_error($koneksi));

  if ($result) {
    echo '<script>alert("Data berhasil diubah"); window.location.href="./gejala.php";</script>'   ;
  } else {
