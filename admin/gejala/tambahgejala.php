...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Tambah Gejala Gangguan Kecemasan</h1>
    </div><!-- End Page Title -->
    ...
    <div class="row">
            ...
            <div class="card-body"> <br><br>
                <form method="post" action="">
                    <div class="form-group row mb-3">
                        <label for="nama_gejala"  class="col-md-2 offset-md-0">Nama Gejala</label>
                        <div class="col-sm-10">
                        <textarea type="text" rows="5" class="form-control" id="nama_gejala" name="nama_gejala" required></textarea>
                        </div>
                    </div>
      ...
      <?php
        ...
        //cek keberadaan data
        $sqlrs = mysqli_query($koneksi, "SELECT kode_gejala FROM gejala WHERE kode_gejala='$kode'");
        $rs = mysqli_num_rows($sqlrs);
        if ($rs == 0) {
          $perintah = "INSERT INTO gejala(kode_gejala,nama_gejala)VALUES('$kode','$gejala')";
          $berhasil = mysqli_query($koneksi, $perintah);

          //jika data berhasil disimpan
          if ($berhasil) {
            echo '<script>alert("Data berhasil disimpan"); window.location.href="./gejala.php";</script>'   ;
          } else {
