...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Gejala Gangguan Kecemasan</h1>
    </div><!-- End Page Title -->
    <br>
    ...
    <section>
      <div class="row">
        <div class="col-md-12">
          ...
          <a href="tambahgejala.php" class="tambah" type="button"><i class="bi bi-pencil-square"></i>  Tambah Gejala</a>
<br><br><br>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td align=justify><?php echo $data['nama_gejala']; ?></td>
                    <td><a href="./editgejala.php?id=<?php echo $data['kode_gejala']; ?>" class="btn btn-warning btn-sm" style="color: white;"><i class="bi bi-pencil"></i> Edit</a></td>
                    <td><a onClick="return HapusData('<?php echo $data['kode_gejala']; ?>');" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusmodal"><i class="bi bi-trash"></i> Hapus</a>
                    </td>
                  </tr><?php } ?>
              </tbody>
            </table>
